...
export default function TodoSkeleton({from}:IProps) {
    return (
        from === "TodoList" ? (
        <div role="status" className="p-4 space-y-6 sm:space-y-4 rounded animate-pulse container">
            ...
            <div role="status" className="p-4 space-y-8 rounded animate-pulse container">
